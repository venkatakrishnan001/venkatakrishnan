    ...
    <section id="about" className="py-24 gradient-section">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold mb-4 text-center animate-fade-in">About Me</h2>
          <div className="w-20 h-1 bg-primary mx-auto mb-12 rounded-full animate-scale-in"></div>
          
          <Card className="p-8 shadow-medium hover:shadow-large transition-smooth animate-fade-in group" style={{ animationDelay: '200ms' }}>
